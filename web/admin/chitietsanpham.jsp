...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            ...
            <div class="container">
                <form action="/demo10/chitietsanpham?id=${sanpham.id}" method="post">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="gia" name="gia" value="${sanphamGiaInt}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="khuyenmai" name="khuyenmai" value="${sanphamKhuyenMaiInt}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="danhmuc" name="danhmuc">
                                    ...
                                    <option value="${sanpham.danhMuc.id}">--${sanpham.danhMuc.ten}--</option>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="mota" id="mota" class="form-control" value="${sanpham.moTa}"></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <button class="btn btn-danger" id="xoa" type="button">Xóa sản phẩm</button>
                </form>
            </div>
        </div>
